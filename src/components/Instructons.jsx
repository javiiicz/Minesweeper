        ...
        <div className="mx-[10%] pb-12">
            ...
            <div className="pl-8">
                <ul className="list-disc">
                    <li>The objective of the game is to decipher where all the mines in the field are located.</li>
                    <li>Click to reveal a cell or press space to flag it.</li>
                    <li>Cells with numbers give the number of mines in the eight cells adjacent to them.</li>
